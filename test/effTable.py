...
pt5 = TPaveText(0.39, 0.05, 0.46, 0.95)
pt6 = TPaveText(0.46, 0.05, 0.53, 0.95)
pt7 = TPaveText(0.53, 0.05, 0.60, 0.95)
pt8 = TPaveText(0.60, 0.05, 0.67, 0.95)
pt9 = TPaveText(0.67, 0.05, 0.74, 0.95)
pt10 = TPaveText(0.74, 0.05, 0.81, 0.95)
pt11 = TPaveText(0.81, 0.05, 0.88, 0.95)
pt12 = TPaveText(0.88, 0.05, 0.95, 0.95)
...
pt12.AddText("#Delta R(higgs, top) > 2")
pt12.AddLine(000, .100, 1.00, .100)
pt12.AddText(str(round(DYToLLnums[11]/DYToLLnums[10],3)))
pt12.AddLine(000, .200, 1.00, .200)
pt12.AddText(str(round(stnums[11]/stnums[10],3)))
pt12.AddLine(000, .300, 1.00, .300)
pt12.AddText(str(round(tt_M2T4nums[11]/tt_M2T4nums[10],3)))
pt12.AddLine(000, .400, 1.00, .400)
pt12.AddText(str(round(WToLNunums[11]/WToLNunums[10],3)))
pt12.AddLine(000, .500, 1.00, .500)
pt12.AddText(str(round(T_M1000_W10nums[11]/T_M1000_W10nums[10],3)))
pt12.AddLine(000, .600, 1.00, .600)
pt12.AddText(str(round(T_M1500_W10nums[11]/T_M1500_W10nums[10],3)))
pt12.AddLine(000, .700, 1.00, .700)
pt12.AddText(str(round(T_M2000_W10nums[11]/T_M2000_W10nums[10],3)))
pt12.AddLine(000, .800, 1.00, .800)
pt12.AddText(str(round(T_M2500_W10nums[11]/T_M2500_W10nums[10],3)))
pt12.AddLine(000, .900, 1.00, .900)
pt12.AddText(str(round(T_M3000_W10nums[11]/T_M3000_W10nums[10],3)))
pt12.Draw()
