...
hjetsPt    = TH1D("hJetsPt", "Jets Pt; Jets Pt (GeV); Events/15 GeV", 200, 0, 2000)
...
hNumBJets = TH1D("hNumBJets", "Number of B Jets; Number of Jets; Events;", 20, 0.0, 20)
...
hhiggssj2csvv2 = TH1D("hhiggssj2csvv2", "Higgs SubJet 2 CSVv2; CSVv2 Value; Events;", 50, 0, 1)
...
hnumak4jets = TH1D("hnumak4jets", "Number of Ak4Jets After Cuts; Number of Ak4Jets; Events;", 20, 0, 20)
...
hST = TH1D("hST", "ST; ST {GeV}; Events;", 50, 0.0, 3000.0)
...
helechannumak4jets = TH1D("helechannumak4jets", "Electron Channel Number of Ak4Jets After Cuts; Number of Ak4Jets; Events;", 20, 0, 20)
...
helechanNumBJets = TH1D("helechanNumBJets", "Electron Channel Number of B Jets; Number of Jets; Events;", 20, 0.0, 20)
heleST = TH1D("heleST", "Electron Channel ST; ST {GeV}; Events;", 50, 0.0, 3000.0)
...
hmuchannumak4jets = TH1D("hmuchannumak4jets", "Muon Channel Number of Ak4Jets After Cuts; Number of Ak4Jets; Events;", 20, 0, 20)
...
hmuchanNumBJets = TH1D("hmuchanNumBJets", "Muon Channel Number of B Jets; Number of Jets; Events;", 50, 0.0, 100)
hmuST = TH1D("hmuST", "Muon Channel ST; ST {GeV}; Events;", 50, 0.0, 3000.0)
...
hctrl0bjetshiggsmass = TH1D("hctrl0bjetshiggsmass", "Higgs Mass in 0 B-jet Control Region; Mass {GeV}; Events;", 40, 0, 400)
hctrl0bjetstopmass = TH1D("hctrl0bjetstopmass", "Top Mass in 0 B-jet Control Region; Mass {GeV}; Events;", 40, 0, 400)
hctrl0bjetstprimemass = TH1D("hctrl0bjetstprimemass", "TPrime Mass in 0 B-jet Control Region; Mass {GeV}; Events;", 40, 0, 5000)
hctrl0bjetsdRtophiggs = TH1D("hctrl0bjetsdRtophiggs", "#Delta R(top, higgs) in 0 B-jet Control Region; #Delta R; Events", 50, 0.0, 5.0)
hctrl0bjetschi2 = TH1D("hctrl0bjetschi2", "Chi2 in 0 B-jet Control Region; Chi2; Events;", 60, 0.0, 600.0)
hctrl1bjetshiggsmass = TH1D("hctrl1bjetshiggsmass", "Higgs Mass in 1 B-jet Control Region; Mass {GeV}; Events;", 40, 0, 400)
hctrl1bjetstopmass = TH1D("hctrl1bjetstopmass", "Top Mass in 1 B-jet Control Region; Mass {GeV}; Events;", 40, 0, 400)
hctrl1bjetstprimemass = TH1D("hctrl1bjetstprimemass", "TPrime Mass in 1 B-jet Control Region; Mass {GeV}; Events;", 40, 0, 5000)
hctrl1bjetsdRtophiggs = TH1D("hctrl1bjetsdRtophiggs", "#Delta R(top, higgs) in 1 B-jet Control Region; #Delta R; Events", 50, 0.0, 5.0)
hctrl1bjetschi2 = TH1D("hctrl1bjetschi2", "Chi2 in 1 B-jet Control Region; Chi2; Events;", 60, 0.0, 600.0)
hctrl2bjetshiggsmass = TH1D("hctrl2bjetshiggsmass", "Higgs Mass in 2+ B-jet Control Region; Mass {GeV}; Events;", 40, 0, 400)
hctrl2bjetstopmass = TH1D("hctrl2bjetstopmass", "Top Mass in 2+ B-jet Control Region; Mass {GeV}; Events;", 40, 0, 400)
hctrl2bjetstprimemass = TH1D("hctrl2bjetstprimemass", "TPrime Mass in 2+ B-jet Control Region; Mass {GeV}; Events;", 40, 0, 5000)
hctrl2bjetsdRtophiggs = TH1D("hctrl2bjetsdRtophiggs", "#Delta R(top, higgs) in 2+ B-jet Control Region; #Delta R; Events", 50, 0.0, 5.0)
hctrl2bjetschi2 = TH1D("hctrl2bjetschi2", "Chi2 in 2+ B-jet Control Region; Chi2; Events;", 60, 0.0, 600.0)

hsig0bjetshiggsmass = TH1D("hsig0bjetshiggsmass", "Higgs Mass in 0 B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 400)
hsig0bjetstopmass = TH1D("hsig0bjetstopmass", "Top Mass in 0 B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 400)
hsig0bjetstprimemass = TH1D("hsig0bjetstprimemass", "TPrime Mass in 0 B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 5000)
hsig0bjetsdRtophiggs = TH1D("hsig0bjetsdRtophiggs", "#Delta R(top, higgs) in 0 B-jet Signal Region; #Delta R; Events", 50, 0.0, 5.0)
hsig0bjetschi2 = TH1D("hsig0bjetschi2", "Chi2 in 0 B-jet Signal Region; Chi2; Events;", 60, 0.0, 600.0)
hsig1bjetshiggsmass = TH1D("hsig1bjetshiggsmass", "Higgs Mass in 1 B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 400)
hsig1bjetstopmass = TH1D("hsig1bjetstopmass", "Top Mass in 1 B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 400)
hsig1bjetstprimemass = TH1D("hsig1bjetstprimemass", "TPrime Mass in 1 B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 5000)
hsig1bjetsdRtophiggs = TH1D("hsig1bjetsdRtophiggs", "#Delta R(top, higgs) in 1 B-jet Signal Region; #Delta R; Events", 50, 0.0, 5.0)
hsig1bjetschi2 = TH1D("hsig1bjetschi2", "Chi2 in 1 B-jet Signal Region; Chi2; Events;", 60, 0.0, 600.0)
hsig2bjetshiggsmass = TH1D("hsig2bjetshiggsmass", "Higgs Mass in 2+ B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 400)
hsig2bjetstopmass = TH1D("hsig2bjetstopmass", "Top Mass in 2+ B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 400)
hsig2bjetstprimemass = TH1D("hsig2bjetstprimemass", "TPrime Mass in 2+ B-jet Signal Region; Mass {GeV}; Events;", 40, 0, 5000)
hsig2bjetsdRtophiggs = TH1D("hsig2bjetsdRtophiggs", "#Delta R(top, higgs) in 2+ B-jet Signal Region; #Delta R; Events", 50, 0.0, 5.0)
hsig2bjetschi2 = TH1D("hsig2bjetschi2", "Chi2 in 2+ B-jet Signal Region; Chi2; Events;", 60, 0.0, 600.0)
...
#------------------------------------------------------------------------
    ...
    pass2D = dPtRel > 25.0 or dRMin > 0.4
	...
	if ak8jet_sj1csvv2[j] < csvv2m: numBjets += 1
	if ak8jet_sj2csvv2[j] < csvv2m: numBjets += 1
...
#------------------------------------------------------------------------
	...
	hCutflow.Fill(ncut, evtwt)
	    ...
	    ncut += 1
	    hCutflow.Fill(ncut, evtwt)
	    if higgsP4.M() < 160 and higgsP4.M() > 60:
	        if numBjets == 0 and numfwrdjets == 0: #control region
		    hctrl0bjetshiggsmass.Fill(higgsP4.M(), evtwt)
                    hctrl0bjetstopmass.Fill(topP4.M(), evtwt)
                    hctrl0bjetstprimemass.Fill(tprimeP4.M(), evtwt)
                    hctrl0bjetsdRtophiggs.Fill(tophiggsdR, evtwt)
                    hctrl0bjetschi2.Fill(chi2, evtwt)
	        if numBjets == 1 and numfwrdjets == 0: #control region
		    hctrl1bjetshiggsmass.Fill(higgsP4.M(), evtwt)
                    hctrl1bjetstopmass.Fill(topP4.M(), evtwt)
                    hctrl1bjetstprimemass.Fill(tprimeP4.M(), evtwt)
                    hctrl1bjetsdRtophiggs.Fill(tophiggsdR, evtwt)
                    hctrl1bjetschi2.Fill(chi2, evtwt)
	        if numBjets >= 2 and numfwrdjets == 0: #control region
		    hctrl2bjetshiggsmass.Fill(higgsP4.M(), evtwt)
                    hctrl2bjetstopmass.Fill(topP4.M(), evtwt)
                    hctrl2bjetstprimemass.Fill(tprimeP4.M(), evtwt)
                    hctrl2bjetsdRtophiggs.Fill(tophiggsdR, evtwt)
                    hctrl2bjetschi2.Fill(chi2, evtwt)
	        if numBjets == 0 and numfwrdjets >= 1: #signal region
		    hsig0bjetshiggsmass.Fill(higgsP4.M(), evtwt)
                    hsig0bjetstopmass.Fill(topP4.M(), evtwt)
                    hsig0bjetstprimemass.Fill(tprimeP4.M(), evtwt)
                    hsig0bjetsdRtophiggs.Fill(tophiggsdR, evtwt)
                    hsig0bjetschi2.Fill(chi2, evtwt)
	        if numBjets == 1 and numfwrdjets >= 1: #signal region
		    hsig1bjetshiggsmass.Fill(higgsP4.M(), evtwt)
                    hsig1bjetstopmass.Fill(topP4.M(), evtwt)
                    hsig1bjetstprimemass.Fill(tprimeP4.M(), evtwt)
                    hsig1bjetsdRtophiggs.Fill(tophiggsdR, evtwt)
                    hsig1bjetschi2.Fill(chi2, evtwt)
	        if numBjets >= 2 and numfwrdjets >= 1: #signal region
		    hsig2bjetshiggsmass.Fill(higgsP4.M(), evtwt)
                    hsig2bjetstopmass.Fill(topP4.M(), evtwt)
                    hsig2bjetstprimemass.Fill(tprimeP4.M(), evtwt)
                    hsig2bjetsdRtophiggs.Fill(tophiggsdR, evtwt)
                    hsig2bjetschi2.Fill(chi2, evtwt)
